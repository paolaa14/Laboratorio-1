...
• Función de probabilidad; consiste en una aproximación de fotms teórica que enseña como se distribuyen los datos en términos generales ( en nuestro caso se observa como una línea curva continua roja).
